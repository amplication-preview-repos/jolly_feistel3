...
@InputType()
class ParticipantCreateNestedManyWithoutConversationsInput {
...
export { ParticipantCreateNestedManyWithoutConversationsInput as ParticipantCreateNestedManyWithoutConversationsInput };
