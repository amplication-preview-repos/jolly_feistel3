...
@InputType()
class ParticipantUpdateManyWithoutConversationsInput {
...
export { ParticipantUpdateManyWithoutConversationsInput as ParticipantUpdateManyWithoutConversationsInput };
